...
public final class PharmaApp1Grpc {

  private PharmaApp1Grpc() {}
  ...
  public static io.grpc.MethodDescriptor<pharmaApp1.LoginRequest,
    ...
    if ((getLoginMethod = PharmaApp1Grpc.getLoginMethod) == null) {
      synchronized (PharmaApp1Grpc.class) {
        if ((getLoginMethod = PharmaApp1Grpc.getLoginMethod) == null) {
          PharmaApp1Grpc.getLoginMethod = getLoginMethod = 
  ...
  public static io.grpc.MethodDescriptor<pharmaApp1.Empty,
    ...
    if ((getLogoutMethod = PharmaApp1Grpc.getLogoutMethod) == null) {
      synchronized (PharmaApp1Grpc.class) {
        if ((getLogoutMethod = PharmaApp1Grpc.getLogoutMethod) == null) {
          PharmaApp1Grpc.getLogoutMethod = getLogoutMethod = 
  ...
  private static abstract class Service1BaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return pharmaApp1.PharmaApp1OuterClass.getDescriptor();
    }

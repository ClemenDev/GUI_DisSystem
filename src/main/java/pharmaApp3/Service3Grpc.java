...
@javax.annotation.Generated(
    ...
    comments = "Source: pharmaApp3.proto")
public final class Service3Grpc {
  ...
  private static volatile io.grpc.MethodDescriptor<pharmaApp3.OrderRequest,
      pharmaApp3.APIResponse> getOrderRequestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "orderRequest",
      requestType = pharmaApp3.OrderRequest.class,
      responseType = pharmaApp3.APIResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<pharmaApp3.OrderRequest,
      pharmaApp3.APIResponse> getOrderRequestMethod() {
    io.grpc.MethodDescriptor<pharmaApp3.OrderRequest, pharmaApp3.APIResponse> getOrderRequestMethod;
    if ((getOrderRequestMethod = Service3Grpc.getOrderRequestMethod) == null) {
      synchronized (Service3Grpc.class) {
        if ((getOrderRequestMethod = Service3Grpc.getOrderRequestMethod) == null) {
          Service3Grpc.getOrderRequestMethod = getOrderRequestMethod = 
              io.grpc.MethodDescriptor.<pharmaApp3.OrderRequest, pharmaApp3.APIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Service3", "orderRequest"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pharmaApp3.OrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pharmaApp3.APIResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new Service3MethodDescriptorSupplier("orderRequest"))
                  .build();
          }
        }
     }
     return getOrderRequestMethod;
  }
  ...
  public static abstract class Service3ImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<pharmaApp3.OrderRequest> orderRequest(
        io.grpc.stub.StreamObserver<pharmaApp3.APIResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getOrderRequestMethod(), responseObserver);
    }

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            getOrderRequestMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                pharmaApp3.OrderRequest,
                pharmaApp3.APIResponse>(
                  this, METHODID_ORDER_REQUEST)))
          .build();
    }
  }
  ...
  public static final class Service3Stub extends io.grpc.stub.AbstractStub<Service3Stub> {
    ...
    public io.grpc.stub.StreamObserver<pharmaApp3.OrderRequest> orderRequest(
      ...
      return asyncBidiStreamingCall(
          getChannel().newCall(getOrderRequestMethod(), getCallOptions()), responseObserver);
    }
  }
  ...
  private static final int METHODID_ORDER_REQUEST = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_ORDER_REQUEST:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.orderRequest(
              (io.grpc.stub.StreamObserver<pharmaApp3.APIResponse>) responseObserver);
        default:
          throw new AssertionError();
      }
  ...
  private static abstract class Service3BaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return pharmaApp3.Service3OuterClass.getDescriptor();
    }
      ...
      synchronized (Service3Grpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getOrderRequestMethod())
              .build();
        }
      }
    }
